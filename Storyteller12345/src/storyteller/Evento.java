...
public class Evento {
   ...
   public int setGetP() {
       //utilizado para retornar um número para ir para o próximo texto
       //vai ser o número da especificação doa posição no vetor
        this.p ++;
        return p;
    }
		...
		if (opcoes.length == 3) {
			...
			return -1;
                    ...
                    public int getEventoEspecial(){
                                //Serao eventos que conterao imagens
