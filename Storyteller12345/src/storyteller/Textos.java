...
public class Textos extends Storyteller {
    ...
    public static String startIntro(){
        return "Oi, bem vindo. \n" 
                + "Espero que voce esteja confortavel. "
                + "\nEu vou te acompanhar em uma historia intrigante, que eu espero que goste."
                + "\nMas antes, gostaria de fazer tres perguntas.\n\n\n";
    }
